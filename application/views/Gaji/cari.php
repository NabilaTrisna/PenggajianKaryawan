...
<legend> Daftar Gaji Karyawan </legend>
    <a class="btn btn-primary" href="<?php echo base_url('gaji/index') ?>">
            Kembali
    </a>
    <br>
    <br>
  ...
  <table class="table table-striped">
    ...
    <tbody>
        ...
        <tr>
          ...
          <td>
          <a href="<?php echo base_url('gaji/show/'.$row->idgaji) ?>">
          <?php 
            foreach($nama as $NP) 
            {
          ...
          <td>
            <B>
            <?php
              echo "Rp" .number_format($row->total_gajibersih,2,',','.'); echo "   / Bulan";
            ?>
            </B>
          </td>
        </tr>
