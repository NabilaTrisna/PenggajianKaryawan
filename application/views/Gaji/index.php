...
<?php $this->load->view('Gaji/Layout/Navigation') ?>
<head>
...
<!-- Start Item Show  -->
<br>
<legend> <font face = "Georgia"> Gaji Pegawai </legend></font>
<br>
    <a class="btn btn-primary" href="<?php echo base_url('gaji/tambah') ?>">
            Tambah
    </a>
  
    <form action="<?php echo base_url('gaji/cariData')?>" action="GET">
    <table>
